module MyTests exposing (Record1(..), Record2(..), Simple01(..), Simple02(..), Simple03(..), Simple04(..), SimpleRecord01(..), SimpleRecord02(..), SimpleRecord03(..), SimpleRecord04(..), Sum01(..), Sum02(..), Sum03(..), Sum04(..), Sum05(..), Sum06(..), Sum07(..), Sum08(..), Sum09(..), Sum10(..), Sum11(..), Sum12(..), SumUntagged(..), equalHack, jsonDecRecord1, jsonDecRecord2, jsonDecSimple01, jsonDecSimple02, jsonDecSimple03, jsonDecSimple04, jsonDecSimpleRecord01, jsonDecSimpleRecord02, jsonDecSimpleRecord03, jsonDecSimpleRecord04, jsonDecSum01, jsonDecSum02, jsonDecSum03, jsonDecSum04, jsonDecSum05, jsonDecSum06, jsonDecSum07, jsonDecSum08, jsonDecSum09, jsonDecSum10, jsonDecSum11, jsonDecSum12, jsonDecSumUntagged, jsonEncRecord1, jsonEncRecord2, jsonEncSimple01, jsonEncSimple02, jsonEncSimple03, jsonEncSimple04, jsonEncSimpleRecord01, jsonEncSimpleRecord02, jsonEncSimpleRecord03, jsonEncSimpleRecord04, jsonEncSum01, jsonEncSum02, jsonEncSum03, jsonEncSum04, jsonEncSum05, jsonEncSum06, jsonEncSum07, jsonEncSum08, jsonEncSum09, jsonEncSum10, jsonEncSum11, jsonEncSum12, jsonEncSumUntagged, recordDecode, recordDecode1, recordDecode2, recordEncode, recordEncode1, recordEncode2, simpleDecode, simpleDecode01, simpleDecode02, simpleDecode03, simpleDecode04, simpleEncode, simpleEncode01, simpleEncode02, simpleEncode03, simpleEncode04, simplerecordDecode01, simplerecordDecode02, simplerecordDecode03, simplerecordDecode04, simplerecordEncode01, simplerecordEncode02, simplerecordEncode03, simplerecordEncode04, sumDecode, sumDecode01, sumDecode02, sumDecode03, sumDecode04, sumDecode05, sumDecode06, sumDecode07, sumDecode08, sumDecode09, sumDecode10, sumDecode11, sumDecode12, sumDecodeUntagged, sumEncode, sumEncode01, sumEncode02, sumEncode03, sumEncode04, sumEncode05, sumEncode06, sumEncode07, sumEncode08, sumEncode09, sumEncode10, sumEncode11, sumEncode12, sumEncodeUntagged)
...
recordDecode : Test
recordDecode =
    describe "Record decoding checks"
        [ recordDecode1
        , recordDecode2
        ]
...
recordEncode : Test
recordEncode =
    describe "Record encoding checks"
        [ recordEncode1
        , recordEncode2
        ]
...
simpleDecode : Test
simpleDecode =
    describe "Simple records/types decoding checks"
        [ simpleDecode01
        , simpleDecode02
        , simpleDecode03
        , simpleDecode04
...
simpleEncode : Test
simpleEncode =
    describe "Simple records/types encoding checks"
        [ simpleEncode01
        , simpleEncode02
        , simpleEncode03
        , simpleEncode04
...
jsonDecRecord1 localDecoder_a =
    andThen (field "foo" Json.Decode.int) <|
        \pfoo ->
            andThen (Json.Decode.maybe (field "bar" Json.Decode.int)) <|
                \pbar ->
                    andThen (field "baz" localDecoder_a) <|
                        \pbaz ->
                            andThen (Json.Decode.maybe (field "qux" localDecoder_a)) <|
                                \pqux ->
    ...
    let
        jsonDecDictSum01 =
            Dict.fromList
                ...
                , ( "Sum01D", Json.Decode.map Sum01D (andThen (field "foo" localDecoder_a) <| \pfoo -> Json.Decode.succeed { foo = pfoo }) )
                , ( "Sum01E", Json.Decode.map Sum01E (andThen (field "bar" Json.Decode.int) <| \pbar -> andThen (field "baz" Json.Decode.int) <| \pbaz -> Json.Decode.succeed { bar = pbar, baz = pbaz }) )
                ]

        jsonDecObjectSetSum01 =
            Set.fromList [ "Sum01D", "Sum01E" ]
    in
    decodeSumTaggedObject "Sum01" "tag" "content" jsonDecDictSum01 jsonDecObjectSetSum01
...
jsonEncSum01 localEncoder_a val =
    let
        keyval v =
            case v of
                Sum01A v1 ->
                    ( "Sum01A", encodeValue (localEncoder_a v1) )

                Sum01B v1 ->
                    ( "Sum01B", encodeValue (maybeEncode localEncoder_a v1) )

                Sum01C v1 v2 ->
                    ( "Sum01C", encodeValue (Json.Encode.list identity [ localEncoder_a v1, localEncoder_a v2 ]) )

                Sum01D vs ->
                    ( "Sum01D", encodeObject [ ( "foo", localEncoder_a vs.foo ) ] )

                Sum01E vs ->
                    ( "Sum01E", encodeObject [ ( "bar", Json.Encode.int vs.bar ), ( "baz", Json.Encode.int vs.baz ) ] )
    in
    encodeSumTaggedObject "tag" "content" keyval val
    ...
    let
        jsonDecDictSum02 =
            Dict.fromList
                ...
                , ( "Sum02D", Json.Decode.map Sum02D (andThen (field "foo" localDecoder_a) <| \pfoo -> Json.Decode.succeed { foo = pfoo }) )
                , ( "Sum02E", Json.Decode.map Sum02E (andThen (field "bar" Json.Decode.int) <| \pbar -> andThen (field "baz" Json.Decode.int) <| \pbaz -> Json.Decode.succeed { bar = pbar, baz = pbaz }) )
                ]

        jsonDecObjectSetSum02 =
            Set.fromList [ "Sum02D", "Sum02E" ]
    in
    decodeSumTaggedObject "Sum02" "tag" "content" jsonDecDictSum02 jsonDecObjectSetSum02
...
jsonEncSum02 localEncoder_a val =
    let
        keyval v =
            case v of
                Sum02A v1 ->
                    ( "Sum02A", encodeValue (localEncoder_a v1) )

                Sum02B v1 ->
                    ( "Sum02B", encodeValue (maybeEncode localEncoder_a v1) )

                Sum02C v1 v2 ->
                    ( "Sum02C", encodeValue (Json.Encode.list identity [ localEncoder_a v1, localEncoder_a v2 ]) )

                Sum02D vs ->
                    ( "Sum02D", encodeObject [ ( "foo", localEncoder_a vs.foo ) ] )

                Sum02E vs ->
                    ( "Sum02E", encodeObject [ ( "bar", Json.Encode.int vs.bar ), ( "baz", Json.Encode.int vs.baz ) ] )
    in
    encodeSumTaggedObject "tag" "content" keyval val
    ...
    let
        jsonDecDictSum03 =
            Dict.fromList
                ...
                , ( "Sum03D", Json.Decode.map Sum03D (andThen (field "foo" localDecoder_a) <| \pfoo -> Json.Decode.succeed { foo = pfoo }) )
                , ( "Sum03E", Json.Decode.map Sum03E (andThen (field "bar" Json.Decode.int) <| \pbar -> andThen (field "baz" Json.Decode.int) <| \pbaz -> Json.Decode.succeed { bar = pbar, baz = pbaz }) )
                ]

        jsonDecObjectSetSum03 =
            Set.fromList [ "Sum03D", "Sum03E" ]
    in
    decodeSumTaggedObject "Sum03" "tag" "content" jsonDecDictSum03 jsonDecObjectSetSum03
...
jsonEncSum03 localEncoder_a val =
    let
        keyval v =
            case v of
                Sum03A v1 ->
                    ( "Sum03A", encodeValue (localEncoder_a v1) )

                Sum03B v1 ->
                    ( "Sum03B", encodeValue (maybeEncode localEncoder_a v1) )

                Sum03C v1 v2 ->
                    ( "Sum03C", encodeValue (Json.Encode.list identity [ localEncoder_a v1, localEncoder_a v2 ]) )

                Sum03D vs ->
                    ( "Sum03D", encodeObject [ ( "foo", localEncoder_a vs.foo ) ] )

                Sum03E vs ->
                    ( "Sum03E", encodeObject [ ( "bar", Json.Encode.int vs.bar ), ( "baz", Json.Encode.int vs.baz ) ] )
    in
    encodeSumTaggedObject "tag" "content" keyval val
    ...
    let
        jsonDecDictSum04 =
            Dict.fromList
                ...
                , ( "Sum04D", Json.Decode.map Sum04D (andThen (field "foo" localDecoder_a) <| \pfoo -> Json.Decode.succeed { foo = pfoo }) )
                , ( "Sum04E", Json.Decode.map Sum04E (andThen (field "bar" Json.Decode.int) <| \pbar -> andThen (field "baz" Json.Decode.int) <| \pbaz -> Json.Decode.succeed { bar = pbar, baz = pbaz }) )
                ]

        jsonDecObjectSetSum04 =
            Set.fromList [ "Sum04D", "Sum04E" ]
    in
    decodeSumTaggedObject "Sum04" "tag" "content" jsonDecDictSum04 jsonDecObjectSetSum04
...
jsonEncSum04 localEncoder_a val =
    let
        keyval v =
            case v of
                Sum04A v1 ->
                    ( "Sum04A", encodeValue (localEncoder_a v1) )

                Sum04B v1 ->
                    ( "Sum04B", encodeValue (maybeEncode localEncoder_a v1) )

                Sum04C v1 v2 ->
                    ( "Sum04C", encodeValue (Json.Encode.list identity [ localEncoder_a v1, localEncoder_a v2 ]) )

                Sum04D vs ->
                    ( "Sum04D", encodeObject [ ( "foo", localEncoder_a vs.foo ) ] )

                Sum04E vs ->
                    ( "Sum04E", encodeObject [ ( "bar", Json.Encode.int vs.bar ), ( "baz", Json.Encode.int vs.baz ) ] )
    in
    encodeSumTaggedObject "tag" "content" keyval val
    ...
    let
        jsonDecDictSum05 =
            Dict.fromList
                ...
                , ( "Sum05D", Json.Decode.map Sum05D (andThen (field "foo" localDecoder_a) <| \pfoo -> Json.Decode.succeed { foo = pfoo }) )
                , ( "Sum05E", Json.Decode.map Sum05E (andThen (field "bar" Json.Decode.int) <| \pbar -> andThen (field "baz" Json.Decode.int) <| \pbaz -> Json.Decode.succeed { bar = pbar, baz = pbaz }) )
                ]
    in
...
jsonEncSum05 localEncoder_a val =
    let
        keyval v =
            case v of
                Sum05A v1 ->
                    ( "Sum05A", encodeValue (localEncoder_a v1) )

                Sum05B v1 ->
                    ( "Sum05B", encodeValue (maybeEncode localEncoder_a v1) )

                Sum05C v1 v2 ->
                    ( "Sum05C", encodeValue (Json.Encode.list identity [ localEncoder_a v1, localEncoder_a v2 ]) )

                Sum05D vs ->
                    ( "Sum05D", encodeObject [ ( "foo", localEncoder_a vs.foo ) ] )

                Sum05E vs ->
                    ( "Sum05E", encodeObject [ ( "bar", Json.Encode.int vs.bar ), ( "baz", Json.Encode.int vs.baz ) ] )
    in
    ...
    let
        jsonDecDictSum06 =
            Dict.fromList
                ...
                , ( "Sum06D", Json.Decode.map Sum06D (andThen (field "foo" localDecoder_a) <| \pfoo -> Json.Decode.succeed { foo = pfoo }) )
                , ( "Sum06E", Json.Decode.map Sum06E (andThen (field "bar" Json.Decode.int) <| \pbar -> andThen (field "baz" Json.Decode.int) <| \pbaz -> Json.Decode.succeed { bar = pbar, baz = pbaz }) )
                ]
    in
...
jsonEncSum06 localEncoder_a val =
    let
        keyval v =
            case v of
                Sum06A v1 ->
                    ( "Sum06A", encodeValue (localEncoder_a v1) )

                Sum06B v1 ->
                    ( "Sum06B", encodeValue (maybeEncode localEncoder_a v1) )

                Sum06C v1 v2 ->
                    ( "Sum06C", encodeValue (Json.Encode.list identity [ localEncoder_a v1, localEncoder_a v2 ]) )

                Sum06D vs ->
                    ( "Sum06D", encodeObject [ ( "foo", localEncoder_a vs.foo ) ] )

                Sum06E vs ->
                    ( "Sum06E", encodeObject [ ( "bar", Json.Encode.int vs.bar ), ( "baz", Json.Encode.int vs.baz ) ] )
    in
    encodeSumObjectWithSingleField keyval val
    ...
    let
        jsonDecDictSum07 =
            Dict.fromList
                ...
                , ( "Sum07D", Json.Decode.map Sum07D (andThen (field "foo" localDecoder_a) <| \pfoo -> Json.Decode.succeed { foo = pfoo }) )
                , ( "Sum07E", Json.Decode.map Sum07E (andThen (field "bar" Json.Decode.int) <| \pbar -> andThen (field "baz" Json.Decode.int) <| \pbaz -> Json.Decode.succeed { bar = pbar, baz = pbaz }) )
                ]
    in
...
jsonEncSum07 localEncoder_a val =
    let
        keyval v =
            case v of
                Sum07A v1 ->
                    ( "Sum07A", encodeValue (localEncoder_a v1) )

                Sum07B v1 ->
                    ( "Sum07B", encodeValue (maybeEncode localEncoder_a v1) )

                Sum07C v1 v2 ->
                    ( "Sum07C", encodeValue (Json.Encode.list identity [ localEncoder_a v1, localEncoder_a v2 ]) )

                Sum07D vs ->
                    ( "Sum07D", encodeObject [ ( "foo", localEncoder_a vs.foo ) ] )

                Sum07E vs ->
                    ( "Sum07E", encodeObject [ ( "bar", Json.Encode.int vs.bar ), ( "baz", Json.Encode.int vs.baz ) ] )
    in
    encodeSumObjectWithSingleField keyval val
    ...
    let
        jsonDecDictSum08 =
            Dict.fromList
                ...
                , ( "Sum08D", Json.Decode.map Sum08D (andThen (field "foo" localDecoder_a) <| \pfoo -> Json.Decode.succeed { foo = pfoo }) )
                , ( "Sum08E", Json.Decode.map Sum08E (andThen (field "bar" Json.Decode.int) <| \pbar -> andThen (field "baz" Json.Decode.int) <| \pbaz -> Json.Decode.succeed { bar = pbar, baz = pbaz }) )
                ]
    in
...
jsonEncSum08 localEncoder_a val =
    let
        keyval v =
            case v of
                Sum08A v1 ->
                    ( "Sum08A", encodeValue (localEncoder_a v1) )

                Sum08B v1 ->
                    ( "Sum08B", encodeValue (maybeEncode localEncoder_a v1) )

                Sum08C v1 v2 ->
                    ( "Sum08C", encodeValue (Json.Encode.list identity [ localEncoder_a v1, localEncoder_a v2 ]) )

                Sum08D vs ->
                    ( "Sum08D", encodeObject [ ( "foo", localEncoder_a vs.foo ) ] )

                Sum08E vs ->
                    ( "Sum08E", encodeObject [ ( "bar", Json.Encode.int vs.bar ), ( "baz", Json.Encode.int vs.baz ) ] )
    in
    encodeSumObjectWithSingleField keyval val
    ...
    let
        jsonDecDictSum09 =
            Dict.fromList
                ...
                , ( "Sum09D", Json.Decode.map Sum09D (andThen (field "foo" localDecoder_a) <| \pfoo -> Json.Decode.succeed { foo = pfoo }) )
                , ( "Sum09E", Json.Decode.map Sum09E (andThen (field "bar" Json.Decode.int) <| \pbar -> andThen (field "baz" Json.Decode.int) <| \pbaz -> Json.Decode.succeed { bar = pbar, baz = pbaz }) )
                ]
    in
...
jsonEncSum09 localEncoder_a val =
    let
        keyval v =
            case v of
                Sum09A v1 ->
                    ( "Sum09A", encodeValue (localEncoder_a v1) )

                Sum09B v1 ->
                    ( "Sum09B", encodeValue (maybeEncode localEncoder_a v1) )

                Sum09C v1 v2 ->
                    ( "Sum09C", encodeValue (Json.Encode.list identity [ localEncoder_a v1, localEncoder_a v2 ]) )

                Sum09D vs ->
                    ( "Sum09D", encodeObject [ ( "foo", localEncoder_a vs.foo ) ] )

                Sum09E vs ->
                    ( "Sum09E", encodeObject [ ( "bar", Json.Encode.int vs.bar ), ( "baz", Json.Encode.int vs.baz ) ] )
    in
    encodeSumTwoElementArray keyval val
    ...
    let
        jsonDecDictSum10 =
            Dict.fromList
                ...
                , ( "Sum10D", Json.Decode.map Sum10D (andThen (field "foo" localDecoder_a) <| \pfoo -> Json.Decode.succeed { foo = pfoo }) )
                , ( "Sum10E", Json.Decode.map Sum10E (andThen (field "bar" Json.Decode.int) <| \pbar -> andThen (field "baz" Json.Decode.int) <| \pbaz -> Json.Decode.succeed { bar = pbar, baz = pbaz }) )
                ]
    in
...
jsonEncSum10 localEncoder_a val =
    let
        keyval v =
            case v of
                Sum10A v1 ->
                    ( "Sum10A", encodeValue (localEncoder_a v1) )

                Sum10B v1 ->
                    ( "Sum10B", encodeValue (maybeEncode localEncoder_a v1) )

                Sum10C v1 v2 ->
                    ( "Sum10C", encodeValue (Json.Encode.list identity [ localEncoder_a v1, localEncoder_a v2 ]) )

                Sum10D vs ->
                    ( "Sum10D", encodeObject [ ( "foo", localEncoder_a vs.foo ) ] )

                Sum10E vs ->
                    ( "Sum10E", encodeObject [ ( "bar", Json.Encode.int vs.bar ), ( "baz", Json.Encode.int vs.baz ) ] )
    in
    encodeSumTwoElementArray keyval val
    ...
    let
        jsonDecDictSum11 =
            Dict.fromList
                ...
                , ( "Sum11D", Json.Decode.map Sum11D (andThen (field "foo" localDecoder_a) <| \pfoo -> Json.Decode.succeed { foo = pfoo }) )
                , ( "Sum11E", Json.Decode.map Sum11E (andThen (field "bar" Json.Decode.int) <| \pbar -> andThen (field "baz" Json.Decode.int) <| \pbaz -> Json.Decode.succeed { bar = pbar, baz = pbaz }) )
                ]
    in
...
jsonEncSum11 localEncoder_a val =
    let
        keyval v =
            case v of
                Sum11A v1 ->
                    ( "Sum11A", encodeValue (localEncoder_a v1) )

                Sum11B v1 ->
                    ( "Sum11B", encodeValue (maybeEncode localEncoder_a v1) )

                Sum11C v1 v2 ->
                    ( "Sum11C", encodeValue (Json.Encode.list identity [ localEncoder_a v1, localEncoder_a v2 ]) )

                Sum11D vs ->
                    ( "Sum11D", encodeObject [ ( "foo", localEncoder_a vs.foo ) ] )

                Sum11E vs ->
                    ( "Sum11E", encodeObject [ ( "bar", Json.Encode.int vs.bar ), ( "baz", Json.Encode.int vs.baz ) ] )
    in
    encodeSumTwoElementArray keyval val
    ...
    let
        jsonDecDictSum12 =
            Dict.fromList
                ...
                , ( "Sum12D", Json.Decode.map Sum12D (andThen (field "foo" localDecoder_a) <| \pfoo -> Json.Decode.succeed { foo = pfoo }) )
                , ( "Sum12E", Json.Decode.map Sum12E (andThen (field "bar" Json.Decode.int) <| \pbar -> andThen (field "baz" Json.Decode.int) <| \pbaz -> Json.Decode.succeed { bar = pbar, baz = pbaz }) )
                ]
    in
...
jsonEncSum12 localEncoder_a val =
    let
        keyval v =
            case v of
                Sum12A v1 ->
                    ( "Sum12A", encodeValue (localEncoder_a v1) )

                Sum12B v1 ->
                    ( "Sum12B", encodeValue (maybeEncode localEncoder_a v1) )

                Sum12C v1 v2 ->
                    ( "Sum12C", encodeValue (Json.Encode.list identity [ localEncoder_a v1, localEncoder_a v2 ]) )

                Sum12D vs ->
                    ( "Sum12D", encodeObject [ ( "foo", localEncoder_a vs.foo ) ] )

                Sum12E vs ->
                    ( "Sum12E", encodeObject [ ( "bar", Json.Encode.int vs.bar ), ( "baz", Json.Encode.int vs.baz ) ] )
    in
    encodeSumTwoElementArray keyval val
...
jsonDecSimpleRecord01 localDecoder_a =
    andThen (field "qux" localDecoder_a) <|
        \pqux ->
...
jsonEncSumUntagged localEncoder_a val =
    let
        keyval v =
            case v of
                SMInt v1 ->
                    ( "SMInt", encodeValue (Json.Encode.int v1) )

                SMList v1 ->
                    ( "SMList", encodeValue (localEncoder_a v1) )
    in
    encodeSumUntagged keyval val


sumEncode01 : Test
sumEncode01 =
    describe "Sum encode 01"
        ...
        , test "2" (\_ -> equalHack "{\"tag\":\"Sum01C\",\"content\":[[2,-1],[1,0]]}" (Json.Encode.encode 0 (jsonEncSum01 (Json.Encode.list Json.Encode.int) (Sum01C [ 2, -1 ] [ 1, 0 ]))))
        , test "3" (\_ -> equalHack "{\"tag\":\"Sum01A\",\"content\":[]}" (Json.Encode.encode 0 (jsonEncSum01 (Json.Encode.list Json.Encode.int) (Sum01A []))))
        , test "4" (\_ -> equalHack "{\"tag\":\"Sum01D\",\"foo\":[4]}" (Json.Encode.encode 0 (jsonEncSum01 (Json.Encode.list Json.Encode.int) (Sum01D { foo = [ 4 ] }))))
        , test "5" (\_ -> equalHack "{\"tag\":\"Sum01A\",\"content\":[]}" (Json.Encode.encode 0 (jsonEncSum01 (Json.Encode.list Json.Encode.int) (Sum01A []))))
        , test "6" (\_ -> equalHack "{\"tag\":\"Sum01B\",\"content\":[2]}" (Json.Encode.encode 0 (jsonEncSum01 (Json.Encode.list Json.Encode.int) (Sum01B (Just [ 2 ])))))
        , test "7" (\_ -> equalHack "{\"tag\":\"Sum01A\",\"content\":[4,8]}" (Json.Encode.encode 0 (jsonEncSum01 (Json.Encode.list Json.Encode.int) (Sum01A [ 4, 8 ]))))
        , test "8" (\_ -> equalHack "{\"tag\":\"Sum01A\",\"content\":[6]}" (Json.Encode.encode 0 (jsonEncSum01 (Json.Encode.list Json.Encode.int) (Sum01A [ 6 ]))))
        , test "9" (\_ -> equalHack "{\"tag\":\"Sum01A\",\"content\":[-6,-7,-9,5,-11,-13,-7,6,4,3,13,-2,3,-6]}" (Json.Encode.encode 0 (jsonEncSum01 (Json.Encode.list Json.Encode.int) (Sum01A [ -6, -7, -9, 5, -11, -13, -7, 6, 4, 3, 13, -2, 3, -6 ]))))
        , test "10" (\_ -> equalHack "{\"tag\":\"Sum01D\",\"foo\":[6,2,-1,4,-14,1,-2,-9,-11,16,2]}" (Json.Encode.encode 0 (jsonEncSum01 (Json.Encode.list Json.Encode.int) (Sum01D { foo = [ 6, 2, -1, 4, -14, 1, -2, -9, -11, 16, 2 ] }))))
        , test "11" (\_ -> equalHack "{\"tag\":\"Sum01A\",\"content\":[-2,-14,-8,-10,-1,19,-10,8]}" (Json.Encode.encode 0 (jsonEncSum01 (Json.Encode.list Json.Encode.int) (Sum01A [ -2, -14, -8, -10, -1, 19, -10, 8 ]))))
        ]


sumEncode02 : Test
sumEncode02 =
    describe "Sum encode 02"
        [ test "1" (\_ -> equalHack "{\"tag\":\"Sum02C\",\"content\":[[],[]]}" (Json.Encode.encode 0 (jsonEncSum02 (Json.Encode.list Json.Encode.int) (Sum02C [] []))))
        , test "2" (\_ -> equalHack "{\"tag\":\"Sum02E\",\"bar\":-2,\"baz\":2}" (Json.Encode.encode 0 (jsonEncSum02 (Json.Encode.list Json.Encode.int) (Sum02E { bar = -2, baz = 2 }))))
        , test "3" (\_ -> equalHack "{\"tag\":\"Sum02E\",\"bar\":4,\"baz\":0}" (Json.Encode.encode 0 (jsonEncSum02 (Json.Encode.list Json.Encode.int) (Sum02E { bar = 4, baz = 0 }))))
        , test "4" (\_ -> equalHack "{\"tag\":\"Sum02A\",\"content\":[]}" (Json.Encode.encode 0 (jsonEncSum02 (Json.Encode.list Json.Encode.int) (Sum02A []))))
        , test "5" (\_ -> equalHack "{\"tag\":\"Sum02E\",\"bar\":6,\"baz\":-1}" (Json.Encode.encode 0 (jsonEncSum02 (Json.Encode.list Json.Encode.int) (Sum02E { bar = 6, baz = -1 }))))
        , test "6" (\_ -> equalHack "{\"tag\":\"Sum02D\",\"foo\":[-5,4,-1,9,1,2,7,5,9]}" (Json.Encode.encode 0 (jsonEncSum02 (Json.Encode.list Json.Encode.int) (Sum02D { foo = [ -5, 4, -1, 9, 1, 2, 7, 5, 9 ] }))))
        , test "7" (\_ -> equalHack "{\"tag\":\"Sum02A\",\"content\":[-11,0,-11,11,2]}" (Json.Encode.encode 0 (jsonEncSum02 (Json.Encode.list Json.Encode.int) (Sum02A [ -11, 0, -11, 11, 2 ]))))
        , test "8" (\_ -> equalHack "{\"tag\":\"Sum02B\",\"content\":[5,8,12,14]}" (Json.Encode.encode 0 (jsonEncSum02 (Json.Encode.list Json.Encode.int) (Sum02B (Just [ 5, 8, 12, 14 ])))))
        , test "9" (\_ -> equalHack "{\"tag\":\"Sum02D\",\"foo\":[-10,1,10,4,6,-4,-3,2,-1,8,6,4,15,5,-12,-2]}" (Json.Encode.encode 0 (jsonEncSum02 (Json.Encode.list Json.Encode.int) (Sum02D { foo = [ -10, 1, 10, 4, 6, -4, -3, 2, -1, 8, 6, 4, 15, 5, -12, -2 ] }))))
        , test "10" (\_ -> equalHack "{\"tag\":\"Sum02D\",\"foo\":[0,17,-11,3,0,17,-6,7,0,-2,12,-8,11,-2,-3,8]}" (Json.Encode.encode 0 (jsonEncSum02 (Json.Encode.list Json.Encode.int) (Sum02D { foo = [ 0, 17, -11, 3, 0, 17, -6, 7, 0, -2, 12, -8, 11, -2, -3, 8 ] }))))
        , test "11" (\_ -> equalHack "{\"tag\":\"Sum02E\",\"bar\":-11,\"baz\":16}" (Json.Encode.encode 0 (jsonEncSum02 (Json.Encode.list Json.Encode.int) (Sum02E { bar = -11, baz = 16 }))))
        ]


sumEncode03 : Test
sumEncode03 =
    describe "Sum encode 03"
        ...
        , test "3" (\_ -> equalHack "{\"tag\":\"Sum03B\",\"content\":[2,-3,1]}" (Json.Encode.encode 0 (jsonEncSum03 (Json.Encode.list Json.Encode.int) (Sum03B (Just [ 2, -3, 1 ])))))
        , test "4" (\_ -> equalHack "{\"tag\":\"Sum03C\",\"content\":[[-4,-1,3],[3]]}" (Json.Encode.encode 0 (jsonEncSum03 (Json.Encode.list Json.Encode.int) (Sum03C [ -4, -1, 3 ] [ 3 ]))))
        , test "5" (\_ -> equalHack "{\"tag\":\"Sum03C\",\"content\":[[-6,-7,-6,-7],[-3,7,5]]}" (Json.Encode.encode 0 (jsonEncSum03 (Json.Encode.list Json.Encode.int) (Sum03C [ -6, -7, -6, -7 ] [ -3, 7, 5 ]))))
        , test "6" (\_ -> equalHack "{\"tag\":\"Sum03D\",\"foo\":[-2,7]}" (Json.Encode.encode 0 (jsonEncSum03 (Json.Encode.list Json.Encode.int) (Sum03D { foo = [ -2, 7 ] }))))
        , test "7" (\_ -> equalHack "{\"tag\":\"Sum03A\",\"content\":[-10,-4,12,-2,5,4,9,-9]}" (Json.Encode.encode 0 (jsonEncSum03 (Json.Encode.list Json.Encode.int) (Sum03A [ -10, -4, 12, -2, 5, 4, 9, -9 ]))))
        , test "8" (\_ -> equalHack "{\"tag\":\"Sum03B\",\"content\":[-1,-9,-4,1,6]}" (Json.Encode.encode 0 (jsonEncSum03 (Json.Encode.list Json.Encode.int) (Sum03B (Just [ -1, -9, -4, 1, 6 ])))))
        , test "9" (\_ -> equalHack "{\"tag\":\"Sum03D\",\"foo\":[8,13,-6,11,9,-7,9,-1,-6,3,14,-8,5,16]}" (Json.Encode.encode 0 (jsonEncSum03 (Json.Encode.list Json.Encode.int) (Sum03D { foo = [ 8, 13, -6, 11, 9, -7, 9, -1, -6, 3, 14, -8, 5, 16 ] }))))
        , test "10" (\_ -> equalHack "{\"tag\":\"Sum03E\",\"bar\":-11,\"baz\":0}" (Json.Encode.encode 0 (jsonEncSum03 (Json.Encode.list Json.Encode.int) (Sum03E { bar = -11, baz = 0 }))))
        , test "11" (\_ -> equalHack "{\"tag\":\"Sum03D\",\"foo\":[1,13,-8,8,-14,-20,20,16,-1,0,-12,-9,15,19,-18,2,15,10,13]}" (Json.Encode.encode 0 (jsonEncSum03 (Json.Encode.list Json.Encode.int) (Sum03D { foo = [ 1, 13, -8, 8, -14, -20, 20, 16, -1, 0, -12, -9, 15, 19, -18, 2, 15, 10, 13 ] }))))
        ]


sumEncode04 : Test
sumEncode04 =
    describe "Sum encode 04"
        [ test "1" (\_ -> equalHack "{\"tag\":\"Sum04C\",\"content\":[[],[]]}" (Json.Encode.encode 0 (jsonEncSum04 (Json.Encode.list Json.Encode.int) (Sum04C [] []))))
        , test "2" (\_ -> equalHack "{\"tag\":\"Sum04D\",\"foo\":[]}" (Json.Encode.encode 0 (jsonEncSum04 (Json.Encode.list Json.Encode.int) (Sum04D { foo = [] }))))
        , test "3" (\_ -> equalHack "{\"tag\":\"Sum04B\",\"content\":[-2,-1,0,1]}" (Json.Encode.encode 0 (jsonEncSum04 (Json.Encode.list Json.Encode.int) (Sum04B (Just [ -2, -1, 0, 1 ])))))
        , test "4" (\_ -> equalHack "{\"tag\":\"Sum04E\",\"bar\":4,\"baz\":-2}" (Json.Encode.encode 0 (jsonEncSum04 (Json.Encode.list Json.Encode.int) (Sum04E { bar = 4, baz = -2 }))))
        , test "5" (\_ -> equalHack "{\"tag\":\"Sum04D\",\"foo\":[-2,2,8,-4,5,-7,5,-2]}" (Json.Encode.encode 0 (jsonEncSum04 (Json.Encode.list Json.Encode.int) (Sum04D { foo = [ -2, 2, 8, -4, 5, -7, 5, -2 ] }))))
        , test "6" (\_ -> equalHack "{\"tag\":\"Sum04A\",\"content\":[-5,-9,-10,-1,1,-10]}" (Json.Encode.encode 0 (jsonEncSum04 (Json.Encode.list Json.Encode.int) (Sum04A [ -5, -9, -10, -1, 1, -10 ]))))
        , test "7" (\_ -> equalHack "{\"tag\":\"Sum04C\",\"content\":[[-7,-1],[12]]}" (Json.Encode.encode 0 (jsonEncSum04 (Json.Encode.list Json.Encode.int) (Sum04C [ -7, -1 ] [ 12 ]))))
        , test "8" (\_ -> equalHack "{\"tag\":\"Sum04C\",\"content\":[[-1,-8,3,12,0,6,9,-8,13,7,-7],[-4,13,-8,-9,-8,1,-1,-8]]}" (Json.Encode.encode 0 (jsonEncSum04 (Json.Encode.list Json.Encode.int) (Sum04C [ -1, -8, 3, 12, 0, 6, 9, -8, 13, 7, -7 ] [ -4, 13, -8, -9, -8, 1, -1, -8 ]))))
        , test "9" (\_ -> equalHack "{\"tag\":\"Sum04A\",\"content\":[-12,11,-9,1,13,12,-11]}" (Json.Encode.encode 0 (jsonEncSum04 (Json.Encode.list Json.Encode.int) (Sum04A [ -12, 11, -9, 1, 13, 12, -11 ]))))
        , test "10" (\_ -> equalHack "{\"tag\":\"Sum04B\",\"content\":[-2,9,0,2,-5,4,17,-5,-17,-12,-6,-4]}" (Json.Encode.encode 0 (jsonEncSum04 (Json.Encode.list Json.Encode.int) (Sum04B (Just [ -2, 9, 0, 2, -5, 4, 17, -5, -17, -12, -6, -4 ])))))
        , test "11" (\_ -> equalHack "{\"tag\":\"Sum04A\",\"content\":[11,-5]}" (Json.Encode.encode 0 (jsonEncSum04 (Json.Encode.list Json.Encode.int) (Sum04A [ 11, -5 ]))))
        ]


sumEncode05 : Test
sumEncode05 =
    describe "Sum encode 05"
        [ test "1" (\_ -> equalHack "{\"Sum05D\":{\"foo\":[]}}" (Json.Encode.encode 0 (jsonEncSum05 (Json.Encode.list Json.Encode.int) (Sum05D { foo = [] }))))
        , test "2" (\_ -> equalHack "{\"Sum05B\":[]}" (Json.Encode.encode 0 (jsonEncSum05 (Json.Encode.list Json.Encode.int) (Sum05B (Just [])))))
        , test "3" (\_ -> equalHack "{\"Sum05C\":[[4,-4,-2],[-1,-4,4]]}" (Json.Encode.encode 0 (jsonEncSum05 (Json.Encode.list Json.Encode.int) (Sum05C [ 4, -4, -2 ] [ -1, -4, 4 ]))))
        , test "4" (\_ -> equalHack "{\"Sum05D\":{\"foo\":[-5,3,2,-4]}}" (Json.Encode.encode 0 (jsonEncSum05 (Json.Encode.list Json.Encode.int) (Sum05D { foo = [ -5, 3, 2, -4 ] }))))
        , test "5" (\_ -> equalHack "{\"Sum05E\":{\"bar\":8,\"baz\":2}}" (Json.Encode.encode 0 (jsonEncSum05 (Json.Encode.list Json.Encode.int) (Sum05E { bar = 8, baz = 2 }))))
        , test "6" (\_ -> equalHack "{\"Sum05E\":{\"bar\":-4,\"baz\":5}}" (Json.Encode.encode 0 (jsonEncSum05 (Json.Encode.list Json.Encode.int) (Sum05E { bar = -4, baz = 5 }))))
        , test "7" (\_ -> equalHack "{\"Sum05E\":{\"bar\":-8,\"baz\":-3}}" (Json.Encode.encode 0 (jsonEncSum05 (Json.Encode.list Json.Encode.int) (Sum05E { bar = -8, baz = -3 }))))
        , test "8" (\_ -> equalHack "{\"Sum05C\":[[3,-10],[]]}" (Json.Encode.encode 0 (jsonEncSum05 (Json.Encode.list Json.Encode.int) (Sum05C [ 3, -10 ] []))))
        , test "9" (\_ -> equalHack "{\"Sum05E\":{\"bar\":-9,\"baz\":-15}}" (Json.Encode.encode 0 (jsonEncSum05 (Json.Encode.list Json.Encode.int) (Sum05E { bar = -9, baz = -15 }))))
        , test "10" (\_ -> equalHack "{\"Sum05A\":[18,-11,-4,-4,-4,-13]}" (Json.Encode.encode 0 (jsonEncSum05 (Json.Encode.list Json.Encode.int) (Sum05A [ 18, -11, -4, -4, -4, -13 ]))))
        , test "11" (\_ -> equalHack "{\"Sum05C\":[[-19,16,11,-8,15,-4,9],[-6,-8,4]]}" (Json.Encode.encode 0 (jsonEncSum05 (Json.Encode.list Json.Encode.int) (Sum05C [ -19, 16, 11, -8, 15, -4, 9 ] [ -6, -8, 4 ]))))
        ]


sumEncode06 : Test
sumEncode06 =
    describe "Sum encode 06"
        ...
        , test "2" (\_ -> equalHack "{\"Sum06A\":[-1]}" (Json.Encode.encode 0 (jsonEncSum06 (Json.Encode.list Json.Encode.int) (Sum06A [ -1 ]))))
        , test "3" (\_ -> equalHack "{\"Sum06C\":[[1],[1,-3,-4,2]]}" (Json.Encode.encode 0 (jsonEncSum06 (Json.Encode.list Json.Encode.int) (Sum06C [ 1 ] [ 1, -3, -4, 2 ]))))
        , test "4" (\_ -> equalHack "{\"Sum06E\":{\"bar\":-5,\"baz\":1}}" (Json.Encode.encode 0 (jsonEncSum06 (Json.Encode.list Json.Encode.int) (Sum06E { bar = -5, baz = 1 }))))
        , test "5" (\_ -> equalHack "{\"Sum06D\":{\"foo\":[]}}" (Json.Encode.encode 0 (jsonEncSum06 (Json.Encode.list Json.Encode.int) (Sum06D { foo = [] }))))
        , test "6" (\_ -> equalHack "{\"Sum06E\":{\"bar\":7,\"baz\":-3}}" (Json.Encode.encode 0 (jsonEncSum06 (Json.Encode.list Json.Encode.int) (Sum06E { bar = 7, baz = -3 }))))
        , test "7" (\_ -> equalHack "{\"Sum06A\":[-4,-10,-6,-10,0,-6,-6,3,-6,7]}" (Json.Encode.encode 0 (jsonEncSum06 (Json.Encode.list Json.Encode.int) (Sum06A [ -4, -10, -6, -10, 0, -6, -6, 3, -6, 7 ]))))
        , test "8" (\_ -> equalHack "{\"Sum06B\":[12,-11,3,-14,-10,13]}" (Json.Encode.encode 0 (jsonEncSum06 (Json.Encode.list Json.Encode.int) (Sum06B (Just [ 12, -11, 3, -14, -10, 13 ])))))
        , test "9" (\_ -> equalHack "{\"Sum06C\":[[9,-7],[16,-14,-14,-12,4,-4,-8,-10,-10,8,11,4]]}" (Json.Encode.encode 0 (jsonEncSum06 (Json.Encode.list Json.Encode.int) (Sum06C [ 9, -7 ] [ 16, -14, -14, -12, 4, -4, -8, -10, -10, 8, 11, 4 ]))))
        , test "10" (\_ -> equalHack "{\"Sum06D\":{\"foo\":[4,3,2,-3,-16,13,16,-5,-13,-9,0,14,-7,-14,-12]}}" (Json.Encode.encode 0 (jsonEncSum06 (Json.Encode.list Json.Encode.int) (Sum06D { foo = [ 4, 3, 2, -3, -16, 13, 16, -5, -13, -9, 0, 14, -7, -14, -12 ] }))))
        , test "11" (\_ -> equalHack "{\"Sum06A\":[11,0,19,-16,-18,13,15,-4,17,-7,-16,-7,9,-12,20]}" (Json.Encode.encode 0 (jsonEncSum06 (Json.Encode.list Json.Encode.int) (Sum06A [ 11, 0, 19, -16, -18, 13, 15, -4, 17, -7, -16, -7, 9, -12, 20 ]))))
        ]


sumEncode07 : Test
sumEncode07 =
    describe "Sum encode 07"
        [ test "1" (\_ -> equalHack "{\"Sum07B\":[]}" (Json.Encode.encode 0 (jsonEncSum07 (Json.Encode.list Json.Encode.int) (Sum07B (Just [])))))
        , test "2" (\_ -> equalHack "{\"Sum07E\":{\"bar\":-2,\"baz\":0}}" (Json.Encode.encode 0 (jsonEncSum07 (Json.Encode.list Json.Encode.int) (Sum07E { bar = -2, baz = 0 }))))
        , test "3" (\_ -> equalHack "{\"Sum07D\":{\"foo\":[]}}" (Json.Encode.encode 0 (jsonEncSum07 (Json.Encode.list Json.Encode.int) (Sum07D { foo = [] }))))
        , test "4" (\_ -> equalHack "{\"Sum07D\":{\"foo\":[]}}" (Json.Encode.encode 0 (jsonEncSum07 (Json.Encode.list Json.Encode.int) (Sum07D { foo = [] }))))
        , test "5" (\_ -> equalHack "{\"Sum07D\":{\"foo\":[1,1,-8,7,0]}}" (Json.Encode.encode 0 (jsonEncSum07 (Json.Encode.list Json.Encode.int) (Sum07D { foo = [ 1, 1, -8, 7, 0 ] }))))
        , test "6" (\_ -> equalHack "{\"Sum07E\":{\"bar\":-2,\"baz\":3}}" (Json.Encode.encode 0 (jsonEncSum07 (Json.Encode.list Json.Encode.int) (Sum07E { bar = -2, baz = 3 }))))
        , test "7" (\_ -> equalHack "{\"Sum07C\":[[-12,8,-9,-4,-3,-1,0,11,6],[11,-4,-2,-8,0,-11,7,12,-9,11]]}" (Json.Encode.encode 0 (jsonEncSum07 (Json.Encode.list Json.Encode.int) (Sum07C [ -12, 8, -9, -4, -3, -1, 0, 11, 6 ] [ 11, -4, -2, -8, 0, -11, 7, 12, -9, 11 ]))))
        , test "8" (\_ -> equalHack "{\"Sum07B\":[12,12,-6,10,-14,-3,-4,-7,7,-3,-5,-1,3]}" (Json.Encode.encode 0 (jsonEncSum07 (Json.Encode.list Json.Encode.int) (Sum07B (Just [ 12, 12, -6, 10, -14, -3, -4, -7, 7, -3, -5, -1, 3 ])))))
        , test "9" (\_ -> equalHack "{\"Sum07C\":[[5,-1,-11,-9,-11,7,16,14,-5,-13,-8,16],[]]}" (Json.Encode.encode 0 (jsonEncSum07 (Json.Encode.list Json.Encode.int) (Sum07C [ 5, -1, -11, -9, -11, 7, 16, 14, -5, -13, -8, 16 ] []))))
        , test "10" (\_ -> equalHack "{\"Sum07C\":[[-10,4,-12],[-11,16,-9,10,-16,5,-4,16,-14,14,16,7]]}" (Json.Encode.encode 0 (jsonEncSum07 (Json.Encode.list Json.Encode.int) (Sum07C [ -10, 4, -12 ] [ -11, 16, -9, 10, -16, 5, -4, 16, -14, 14, 16, 7 ]))))
        , test "11" (\_ -> equalHack "{\"Sum07A\":[4,7,11,18,-5,-7,-9,-16,-14]}" (Json.Encode.encode 0 (jsonEncSum07 (Json.Encode.list Json.Encode.int) (Sum07A [ 4, 7, 11, 18, -5, -7, -9, -16, -14 ]))))
        ]


sumEncode08 : Test
sumEncode08 =
    describe "Sum encode 08"
        ...
        , test "3" (\_ -> equalHack "{\"Sum08D\":{\"foo\":[1,2]}}" (Json.Encode.encode 0 (jsonEncSum08 (Json.Encode.list Json.Encode.int) (Sum08D { foo = [ 1, 2 ] }))))
        , test "4" (\_ -> equalHack "{\"Sum08D\":{\"foo\":[-1,3,-2,-3,-4,1]}}" (Json.Encode.encode 0 (jsonEncSum08 (Json.Encode.list Json.Encode.int) (Sum08D { foo = [ -1, 3, -2, -3, -4, 1 ] }))))
        , test "5" (\_ -> equalHack "{\"Sum08C\":[[3,-8],[5,-4,7,6,-7,5,5]]}" (Json.Encode.encode 0 (jsonEncSum08 (Json.Encode.list Json.Encode.int) (Sum08C [ 3, -8 ] [ 5, -4, 7, 6, -7, 5, 5 ]))))
        , test "6" (\_ -> equalHack "{\"Sum08B\":[1,0,-1]}" (Json.Encode.encode 0 (jsonEncSum08 (Json.Encode.list Json.Encode.int) (Sum08B (Just [ 1, 0, -1 ])))))
        , test "7" (\_ -> equalHack "{\"Sum08B\":[]}" (Json.Encode.encode 0 (jsonEncSum08 (Json.Encode.list Json.Encode.int) (Sum08B (Just [])))))
        , test "8" (\_ -> equalHack "{\"Sum08A\":[4,5,-1,2,-14,-9,11]}" (Json.Encode.encode 0 (jsonEncSum08 (Json.Encode.list Json.Encode.int) (Sum08A [ 4, 5, -1, 2, -14, -9, 11 ]))))
        , test "9" (\_ -> equalHack "{\"Sum08C\":[[2,-3,14,10,-5,-5,0,11,1,-4,-2,13,9,5,-9],[9,1,-2,15,-11,3,-14,1,-9,-11,15,-5,-1,-10]]}" (Json.Encode.encode 0 (jsonEncSum08 (Json.Encode.list Json.Encode.int) (Sum08C [ 2, -3, 14, 10, -5, -5, 0, 11, 1, -4, -2, 13, 9, 5, -9 ] [ 9, 1, -2, 15, -11, 3, -14, 1, -9, -11, 15, -5, -1, -10 ]))))
        , test "10" (\_ -> equalHack "{\"Sum08C\":[[-11,-4,-5,6,-6,18,16,-18,-17,-16],[-3,6,-16,11,-12,11,-3,11,-2,-3,16,10]]}" (Json.Encode.encode 0 (jsonEncSum08 (Json.Encode.list Json.Encode.int) (Sum08C [ -11, -4, -5, 6, -6, 18, 16, -18, -17, -16 ] [ -3, 6, -16, 11, -12, 11, -3, 11, -2, -3, 16, 10 ]))))
        , test "11" (\_ -> equalHack "{\"Sum08D\":{\"foo\":[-20,7,-7,-11,11,4,-1,-20,20,-11,-2,10,-10]}}" (Json.Encode.encode 0 (jsonEncSum08 (Json.Encode.list Json.Encode.int) (Sum08D { foo = [ -20, 7, -7, -11, 11, 4, -1, -20, 20, -11, -2, 10, -10 ] }))))
        ]


sumEncode09 : Test
sumEncode09 =
    describe "Sum encode 09"
        [ test "1" (\_ -> equalHack "[\"Sum09C\",[[],[]]]" (Json.Encode.encode 0 (jsonEncSum09 (Json.Encode.list Json.Encode.int) (Sum09C [] []))))
        , test "2" (\_ -> equalHack "[\"Sum09D\",{\"foo\":[0]}]" (Json.Encode.encode 0 (jsonEncSum09 (Json.Encode.list Json.Encode.int) (Sum09D { foo = [ 0 ] }))))
        , test "3" (\_ -> equalHack "[\"Sum09C\",[[],[-3,0,3]]]" (Json.Encode.encode 0 (jsonEncSum09 (Json.Encode.list Json.Encode.int) (Sum09C [] [ -3, 0, 3 ]))))
        , test "4" (\_ -> equalHack "[\"Sum09D\",{\"foo\":[-2]}]" (Json.Encode.encode 0 (jsonEncSum09 (Json.Encode.list Json.Encode.int) (Sum09D { foo = [ -2 ] }))))
        , test "5" (\_ -> equalHack "[\"Sum09C\",[[0,5,4,6,1,8],[5,7,7]]]" (Json.Encode.encode 0 (jsonEncSum09 (Json.Encode.list Json.Encode.int) (Sum09C [ 0, 5, 4, 6, 1, 8 ] [ 5, 7, 7 ]))))
        , test "6" (\_ -> equalHack "[\"Sum09B\",[-1,9,5]]" (Json.Encode.encode 0 (jsonEncSum09 (Json.Encode.list Json.Encode.int) (Sum09B (Just [ -1, 9, 5 ])))))
        , test "7" (\_ -> equalHack "[\"Sum09A\",[5,-12,4,7,-10]]" (Json.Encode.encode 0 (jsonEncSum09 (Json.Encode.list Json.Encode.int) (Sum09A [ 5, -12, 4, 7, -10 ]))))
        , test "8" (\_ -> equalHack "[\"Sum09E\",{\"bar\":-3,\"baz\":13}]" (Json.Encode.encode 0 (jsonEncSum09 (Json.Encode.list Json.Encode.int) (Sum09E { bar = -3, baz = 13 }))))
        , test "9" (\_ -> equalHack "[\"Sum09E\",{\"bar\":-14,\"baz\":-7}]" (Json.Encode.encode 0 (jsonEncSum09 (Json.Encode.list Json.Encode.int) (Sum09E { bar = -14, baz = -7 }))))
        , test "10" (\_ -> equalHack "[\"Sum09D\",{\"foo\":[5,8,-7,-8,-2,-7,2,-16,-2,8,-6,6,-5,12]}]" (Json.Encode.encode 0 (jsonEncSum09 (Json.Encode.list Json.Encode.int) (Sum09D { foo = [ 5, 8, -7, -8, -2, -7, 2, -16, -2, 8, -6, 6, -5, 12 ] }))))
        , test "11" (\_ -> equalHack "[\"Sum09D\",{\"foo\":[9,-20,8,5,6,10,-18,-13,-5,8,8,-16,-20,13,11,-8,16,-16]}]" (Json.Encode.encode 0 (jsonEncSum09 (Json.Encode.list Json.Encode.int) (Sum09D { foo = [ 9, -20, 8, 5, 6, 10, -18, -13, -5, 8, 8, -16, -20, 13, 11, -8, 16, -16 ] }))))
        ]


sumEncode10 : Test
sumEncode10 =
    describe "Sum encode 10"
        [ test "1" (\_ -> equalHack "[\"Sum10C\",[[],[]]]" (Json.Encode.encode 0 (jsonEncSum10 (Json.Encode.list Json.Encode.int) (Sum10C [] []))))
        , test "2" (\_ -> equalHack "[\"Sum10C\",[[],[0]]]" (Json.Encode.encode 0 (jsonEncSum10 (Json.Encode.list Json.Encode.int) (Sum10C [] [ 0 ]))))
        , test "3" (\_ -> equalHack "[\"Sum10D\",{\"foo\":[-1,2]}]" (Json.Encode.encode 0 (jsonEncSum10 (Json.Encode.list Json.Encode.int) (Sum10D { foo = [ -1, 2 ] }))))
        , test "4" (\_ -> equalHack "[\"Sum10D\",{\"foo\":[]}]" (Json.Encode.encode 0 (jsonEncSum10 (Json.Encode.list Json.Encode.int) (Sum10D { foo = [] }))))
        , test "5" (\_ -> equalHack "[\"Sum10C\",[[3,-4,-4,6,-4,-7,1],[-1,-6,-1,3,7,-5,2,-2]]]" (Json.Encode.encode 0 (jsonEncSum10 (Json.Encode.list Json.Encode.int) (Sum10C [ 3, -4, -4, 6, -4, -7, 1 ] [ -1, -6, -1, 3, 7, -5, 2, -2 ]))))
        , test "6" (\_ -> equalHack "[\"Sum10B\",[-9]]" (Json.Encode.encode 0 (jsonEncSum10 (Json.Encode.list Json.Encode.int) (Sum10B (Just [ -9 ])))))
        , test "7" (\_ -> equalHack "[\"Sum10E\",{\"bar\":10,\"baz\":5}]" (Json.Encode.encode 0 (jsonEncSum10 (Json.Encode.list Json.Encode.int) (Sum10E { bar = 10, baz = 5 }))))
        , test "8" (\_ -> equalHack "[\"Sum10A\",[8,7,7,-10,-1,3,8,-13,-14,12,2,7,-10,-10]]" (Json.Encode.encode 0 (jsonEncSum10 (Json.Encode.list Json.Encode.int) (Sum10A [ 8, 7, 7, -10, -1, 3, 8, -13, -14, 12, 2, 7, -10, -10 ]))))
        , test "9" (\_ -> equalHack "[\"Sum10C\",[[4,-4,9,8,1,-11,-13,14],[11,12,-10,-9,-2,12,-1,0,13,9,9,4,-11,6,10]]]" (Json.Encode.encode 0 (jsonEncSum10 (Json.Encode.list Json.Encode.int) (Sum10C [ 4, -4, 9, 8, 1, -11, -13, 14 ] [ 11, 12, -10, -9, -2, 12, -1, 0, 13, 9, 9, 4, -11, 6, 10 ]))))
        , test "10" (\_ -> equalHack "[\"Sum10A\",[6,-5,-1,7,-12,-12,-3,-10,-12,5,-3,17,13,-15]]" (Json.Encode.encode 0 (jsonEncSum10 (Json.Encode.list Json.Encode.int) (Sum10A [ 6, -5, -1, 7, -12, -12, -3, -10, -12, 5, -3, 17, 13, -15 ]))))
        , test "11" (\_ -> equalHack "[\"Sum10B\",[16,-4,9,16,-17,-7,10,10,6,-2,-13,7,-4,12,-4]]" (Json.Encode.encode 0 (jsonEncSum10 (Json.Encode.list Json.Encode.int) (Sum10B (Just [ 16, -4, 9, 16, -17, -7, 10, 10, 6, -2, -13, 7, -4, 12, -4 ])))))
        ]


sumEncode11 : Test
sumEncode11 =
    describe "Sum encode 11"
        ...
        , test "3" (\_ -> equalHack "[\"Sum11A\",[2,1]]" (Json.Encode.encode 0 (jsonEncSum11 (Json.Encode.list Json.Encode.int) (Sum11A [ 2, 1 ]))))
        , test "4" (\_ -> equalHack "[\"Sum11C\",[[-4],[-1,3]]]" (Json.Encode.encode 0 (jsonEncSum11 (Json.Encode.list Json.Encode.int) (Sum11C [ -4 ] [ -1, 3 ]))))
        , test "5" (\_ -> equalHack "[\"Sum11A\",[-1,5,-3,-8,6,-3,0,1]]" (Json.Encode.encode 0 (jsonEncSum11 (Json.Encode.list Json.Encode.int) (Sum11A [ -1, 5, -3, -8, 6, -3, 0, 1 ]))))
        , test "6" (\_ -> equalHack "[\"Sum11D\",{\"foo\":[7]}]" (Json.Encode.encode 0 (jsonEncSum11 (Json.Encode.list Json.Encode.int) (Sum11D { foo = [ 7 ] }))))
        , test "7" (\_ -> equalHack "[\"Sum11D\",{\"foo\":[8,-7,-7,-4,-10,-5,6,-9,7]}]" (Json.Encode.encode 0 (jsonEncSum11 (Json.Encode.list Json.Encode.int) (Sum11D { foo = [ 8, -7, -7, -4, -10, -5, 6, -9, 7 ] }))))
        , test "8" (\_ -> equalHack "[\"Sum11A\",[1,-9,-4,-6,-5,-6]]" (Json.Encode.encode 0 (jsonEncSum11 (Json.Encode.list Json.Encode.int) (Sum11A [ 1, -9, -4, -6, -5, -6 ]))))
        , test "9" (\_ -> equalHack "[\"Sum11D\",{\"foo\":[]}]" (Json.Encode.encode 0 (jsonEncSum11 (Json.Encode.list Json.Encode.int) (Sum11D { foo = [] }))))
        , test "10" (\_ -> equalHack "[\"Sum11E\",{\"bar\":11,\"baz\":-10}]" (Json.Encode.encode 0 (jsonEncSum11 (Json.Encode.list Json.Encode.int) (Sum11E { bar = 11, baz = -10 }))))
        , test "11" (\_ -> equalHack "[\"Sum11B\",[19,-1,20,-16,19,-4,-6,0,20,6,7,-12,-14,-20,10,-4,14]]" (Json.Encode.encode 0 (jsonEncSum11 (Json.Encode.list Json.Encode.int) (Sum11B (Just [ 19, -1, 20, -16, 19, -4, -6, 0, 20, 6, 7, -12, -14, -20, 10, -4, 14 ])))))
        ]


sumEncode12 : Test
sumEncode12 =
    describe "Sum encode 12"
        [ test "1" (\_ -> equalHack "[\"Sum12B\",[]]" (Json.Encode.encode 0 (jsonEncSum12 (Json.Encode.list Json.Encode.int) (Sum12B (Just [])))))
        , test "2" (\_ -> equalHack "[\"Sum12C\",[[2],[0]]]" (Json.Encode.encode 0 (jsonEncSum12 (Json.Encode.list Json.Encode.int) (Sum12C [ 2 ] [ 0 ]))))
        , test "3" (\_ -> equalHack "[\"Sum12E\",{\"bar\":3,\"baz\":-2}]" (Json.Encode.encode 0 (jsonEncSum12 (Json.Encode.list Json.Encode.int) (Sum12E { bar = 3, baz = -2 }))))
        , test "4" (\_ -> equalHack "[\"Sum12D\",{\"foo\":[1,-3,5,3]}]" (Json.Encode.encode 0 (jsonEncSum12 (Json.Encode.list Json.Encode.int) (Sum12D { foo = [ 1, -3, 5, 3 ] }))))
        , test "5" (\_ -> equalHack "[\"Sum12C\",[[],[4,1,-7,-8]]]" (Json.Encode.encode 0 (jsonEncSum12 (Json.Encode.list Json.Encode.int) (Sum12C [] [ 4, 1, -7, -8 ]))))
        , test "6" (\_ -> equalHack "[\"Sum12C\",[[5,9,-5,3,-6,1,-7,-3,-1],[7,-10,-6,1,-5,-9,-9,8,-5]]]" (Json.Encode.encode 0 (jsonEncSum12 (Json.Encode.list Json.Encode.int) (Sum12C [ 5, 9, -5, 3, -6, 1, -7, -3, -1 ] [ 7, -10, -6, 1, -5, -9, -9, 8, -5 ]))))
        , test "7" (\_ -> equalHack "[\"Sum12C\",[[-11,8,3,3,-3,0,-1],[7,-7,1,5,-11,-3]]]" (Json.Encode.encode 0 (jsonEncSum12 (Json.Encode.list Json.Encode.int) (Sum12C [ -11, 8, 3, 3, -3, 0, -1 ] [ 7, -7, 1, 5, -11, -3 ]))))
        , test "8" (\_ -> equalHack "[\"Sum12C\",[[9,4,-1,-8,-5],[]]]" (Json.Encode.encode 0 (jsonEncSum12 (Json.Encode.list Json.Encode.int) (Sum12C [ 9, 4, -1, -8, -5 ] []))))
        , test "9" (\_ -> equalHack "[\"Sum12E\",{\"bar\":0,\"baz\":4}]" (Json.Encode.encode 0 (jsonEncSum12 (Json.Encode.list Json.Encode.int) (Sum12E { bar = 0, baz = 4 }))))
        , test "10" (\_ -> equalHack "[\"Sum12A\",[-10,3,-18,14,4,-6,10,-7,-9]]" (Json.Encode.encode 0 (jsonEncSum12 (Json.Encode.list Json.Encode.int) (Sum12A [ -10, 3, -18, 14, 4, -6, 10, -7, -9 ]))))
        , test "11" (\_ -> equalHack "[\"Sum12E\",{\"bar\":20,\"baz\":5}]" (Json.Encode.encode 0 (jsonEncSum12 (Json.Encode.list Json.Encode.int) (Sum12E { bar = 20, baz = 5 }))))
        ]


sumDecode01 : Test
sumDecode01 =
    describe "Sum decode 01"
...
recordEncode1 : Test
recordEncode1 =
    describe "Record encode 1"
        [ test "1" (\_ -> equalHack "{\"foo\":0,\"bar\":0,\"baz\":[],\"qux\":[]}" (Json.Encode.encode 0 (jsonEncRecord1 (Json.Encode.list Json.Encode.int) (Record1 { foo = 0, bar = Just 0, baz = [], qux = Just [] }))))
        , test "2" (\_ -> equalHack "{\"foo\":-1,\"bar\":-1,\"baz\":[],\"qux\":[1]}" (Json.Encode.encode 0 (jsonEncRecord1 (Json.Encode.list Json.Encode.int) (Record1 { foo = -1, bar = Just -1, baz = [], qux = Just [ 1 ] }))))
        , test "3" (\_ -> equalHack "{\"foo\":-3,\"bar\":4,\"baz\":[1,2],\"qux\":[-4,3,4,2]}" (Json.Encode.encode 0 (jsonEncRecord1 (Json.Encode.list Json.Encode.int) (Record1 { foo = -3, bar = Just 4, baz = [ 1, 2 ], qux = Just [ -4, 3, 4, 2 ] }))))
        , test "4" (\_ -> equalHack "{\"foo\":6,\"bar\":6,\"baz\":[2,-3,1],\"qux\":[1,-3]}" (Json.Encode.encode 0 (jsonEncRecord1 (Json.Encode.list Json.Encode.int) (Record1 { foo = 6, bar = Just 6, baz = [ 2, -3, 1 ], qux = Just [ 1, -3 ] }))))
        , test "5" (\_ -> equalHack "{\"foo\":-1,\"bar\":-7,\"baz\":[-7,-5],\"qux\":[-7,-5,-2,0,-7,-5,2,1]}" (Json.Encode.encode 0 (jsonEncRecord1 (Json.Encode.list Json.Encode.int) (Record1 { foo = -1, bar = Just -7, baz = [ -7, -5 ], qux = Just [ -7, -5, -2, 0, -7, -5, 2, 1 ] }))))
        , test "6" (\_ -> equalHack "{\"foo\":-1,\"bar\":8,\"baz\":[-3,-9,2,-1,-6,-6,7,-3,1,-5],\"qux\":[-4,5]}" (Json.Encode.encode 0 (jsonEncRecord1 (Json.Encode.list Json.Encode.int) (Record1 { foo = -1, bar = Just 8, baz = [ -3, -9, 2, -1, -6, -6, 7, -3, 1, -5 ], qux = Just [ -4, 5 ] }))))
        , test "7" (\_ -> equalHack "{\"foo\":1,\"bar\":-2,\"baz\":[-6,-6,12,12,6,0,1],\"qux\":[12,12,-3,-5,1]}" (Json.Encode.encode 0 (jsonEncRecord1 (Json.Encode.list Json.Encode.int) (Record1 { foo = 1, bar = Just -2, baz = [ -6, -6, 12, 12, 6, 0, 1 ], qux = Just [ 12, 12, -3, -5, 1 ] }))))
        , test "8" (\_ -> equalHack "{\"foo\":10,\"bar\":-4,\"baz\":[-12,-12,-4],\"qux\":[-13,-7,12,1,14,13,-5,6,0,5,-12,4]}" (Json.Encode.encode 0 (jsonEncRecord1 (Json.Encode.list Json.Encode.int) (Record1 { foo = 10, bar = Just -4, baz = [ -12, -12, -4 ], qux = Just [ -13, -7, 12, 1, 14, 13, -5, 6, 0, 5, -12, 4 ] }))))
        , test "9" (\_ -> equalHack "{\"foo\":-3,\"bar\":0,\"baz\":[-1,-4,-16,11,13],\"qux\":[12,2,9,-16,7,-7,13,1]}" (Json.Encode.encode 0 (jsonEncRecord1 (Json.Encode.list Json.Encode.int) (Record1 { foo = -3, bar = Just 0, baz = [ -1, -4, -16, 11, 13 ], qux = Just [ 12, 2, 9, -16, 7, -7, 13, 1 ] }))))
        , test "10" (\_ -> equalHack "{\"foo\":-16,\"bar\":0,\"baz\":[-15,-16,14,3,3,-5,16,6],\"qux\":[7,-14,-4,-18,-11,-15,6,-13,-11,-3,17]}" (Json.Encode.encode 0 (jsonEncRecord1 (Json.Encode.list Json.Encode.int) (Record1 { foo = -16, bar = Just 0, baz = [ -15, -16, 14, 3, 3, -5, 16, 6 ], qux = Just [ 7, -14, -4, -18, -11, -15, 6, -13, -11, -3, 17 ] }))))
        , test "11" (\_ -> equalHack "{\"foo\":9,\"bar\":19,\"baz\":[13,5,9,18,17,5,-4,20],\"qux\":[2,19,11,-18,-18,-8,-6,10,19,-7,-13]}" (Json.Encode.encode 0 (jsonEncRecord1 (Json.Encode.list Json.Encode.int) (Record1 { foo = 9, bar = Just 19, baz = [ 13, 5, 9, 18, 17, 5, -4, 20 ], qux = Just [ 2, 19, 11, -18, -18, -8, -6, 10, 19, -7, -13 ] }))))
        ]


recordEncode2 : Test
recordEncode2 =
    describe "Record encode 2"
        ...
        , test "2" (\_ -> equalHack "{\"bar\":2,\"qux\":[0],\"foo\":-2,\"baz\":[0]}" (Json.Encode.encode 0 (jsonEncRecord2 (Json.Encode.list Json.Encode.int) (Record2 { foo = -2, bar = Just 2, baz = [ 0 ], qux = Just [ 0 ] }))))
        , test "3" (\_ -> equalHack "{\"bar\":-2,\"qux\":[],\"foo\":-3,\"baz\":[-3,-1,0]}" (Json.Encode.encode 0 (jsonEncRecord2 (Json.Encode.list Json.Encode.int) (Record2 { foo = -3, bar = Just -2, baz = [ -3, -1, 0 ], qux = Just [] }))))
        , test "4" (\_ -> equalHack "{\"bar\":-1,\"qux\":[-2,4,-6,1],\"foo\":3,\"baz\":[-5,1,0,-1,0]}" (Json.Encode.encode 0 (jsonEncRecord2 (Json.Encode.list Json.Encode.int) (Record2 { foo = 3, bar = Just -1, baz = [ -5, 1, 0, -1, 0 ], qux = Just [ -2, 4, -6, 1 ] }))))
        , test "5" (\_ -> equalHack "{\"bar\":-3,\"qux\":[-7,0,-6,-4],\"foo\":2,\"baz\":[0,-2,1,-3]}" (Json.Encode.encode 0 (jsonEncRecord2 (Json.Encode.list Json.Encode.int) (Record2 { foo = 2, bar = Just -3, baz = [ 0, -2, 1, -3 ], qux = Just [ -7, 0, -6, -4 ] }))))
        , test "6" (\_ -> equalHack "{\"bar\":-10,\"qux\":[-4,-10,5],\"foo\":3,\"baz\":[9,-5,8,2,-9,6]}" (Json.Encode.encode 0 (jsonEncRecord2 (Json.Encode.list Json.Encode.int) (Record2 { foo = 3, bar = Just -10, baz = [ 9, -5, 8, 2, -9, 6 ], qux = Just [ -4, -10, 5 ] }))))
        , test "7" (\_ -> equalHack "{\"bar\":-6,\"qux\":[12,-11,-6,7,11,3,3],\"foo\":12,\"baz\":[8,8,-10,-9,7,9,2]}" (Json.Encode.encode 0 (jsonEncRecord2 (Json.Encode.list Json.Encode.int) (Record2 { foo = 12, bar = Just -6, baz = [ 8, 8, -10, -9, 7, 9, 2 ], qux = Just [ 12, -11, -6, 7, 11, 3, 3 ] }))))
        , test "8" (\_ -> equalHack "{\"bar\":13,\"qux\":[-11,10,13,-5],\"foo\":0,\"baz\":[-13,-8,-10,3,-12,-3,11,14]}" (Json.Encode.encode 0 (jsonEncRecord2 (Json.Encode.list Json.Encode.int) (Record2 { foo = 0, bar = Just 13, baz = [ -13, -8, -10, 3, -12, -3, 11, 14 ], qux = Just [ -11, 10, 13, -5 ] }))))
        , test "9" (\_ -> equalHack "{\"bar\":-5,\"qux\":[-14,-8,15,-12,2],\"foo\":-10,\"baz\":[7,-9,-9,-11,7,8,1,3,-7,15,2,14]}" (Json.Encode.encode 0 (jsonEncRecord2 (Json.Encode.list Json.Encode.int) (Record2 { foo = -10, bar = Just -5, baz = [ 7, -9, -9, -11, 7, 8, 1, 3, -7, 15, 2, 14 ], qux = Just [ -14, -8, 15, -12, 2 ] }))))
        , test "10" (\_ -> equalHack "{\"bar\":0,\"qux\":[],\"foo\":9,\"baz\":[18]}" (Json.Encode.encode 0 (jsonEncRecord2 (Json.Encode.list Json.Encode.int) (Record2 { foo = 9, bar = Just 0, baz = [ 18 ], qux = Just [] }))))
        , test "11" (\_ -> equalHack "{\"bar\":-5,\"qux\":[10,-14,15,20,12,-15,14,-9,20],\"foo\":-19,\"baz\":[-10,4,-9,-17,20,15]}" (Json.Encode.encode 0 (jsonEncRecord2 (Json.Encode.list Json.Encode.int) (Record2 { foo = -19, bar = Just -5, baz = [ -10, 4, -9, -17, 20, 15 ], qux = Just [ 10, -14, 15, 20, 12, -15, 14, -9, 20 ] }))))
        ]


simpleEncode01 : Test
simpleEncode01 =
    describe "Simple encode 01"
        ...
        , test "4" (\_ -> equalHack "[6,-1,1,-5]" (Json.Encode.encode 0 (jsonEncSimple01 (Json.Encode.list Json.Encode.int) (Simple01 [ 6, -1, 1, -5 ]))))
        , test "5" (\_ -> equalHack "[-2,-8,6,-5,-2,1,3,0]" (Json.Encode.encode 0 (jsonEncSimple01 (Json.Encode.list Json.Encode.int) (Simple01 [ -2, -8, 6, -5, -2, 1, 3, 0 ]))))
        , test "6" (\_ -> equalHack "[]" (Json.Encode.encode 0 (jsonEncSimple01 (Json.Encode.list Json.Encode.int) (Simple01 []))))
        , test "7" (\_ -> equalHack "[6]" (Json.Encode.encode 0 (jsonEncSimple01 (Json.Encode.list Json.Encode.int) (Simple01 [ 6 ]))))
        , test "8" (\_ -> equalHack "[2,-1,-2,-10,11,12,-4,-14,3]" (Json.Encode.encode 0 (jsonEncSimple01 (Json.Encode.list Json.Encode.int) (Simple01 [ 2, -1, -2, -10, 11, 12, -4, -14, 3 ]))))
        , test "9" (\_ -> equalHack "[-10,1,11,9,7,-8,-13,-11,8,-12,-8,-10,-4]" (Json.Encode.encode 0 (jsonEncSimple01 (Json.Encode.list Json.Encode.int) (Simple01 [ -10, 1, 11, 9, 7, -8, -13, -11, 8, -12, -8, -10, -4 ]))))
        , test "10" (\_ -> equalHack "[-11,-16,6,7]" (Json.Encode.encode 0 (jsonEncSimple01 (Json.Encode.list Json.Encode.int) (Simple01 [ -11, -16, 6, 7 ]))))
        , test "11" (\_ -> equalHack "[-17,-1,6,-20,-8,-2,18,-8,-1,-7,11,18]" (Json.Encode.encode 0 (jsonEncSimple01 (Json.Encode.list Json.Encode.int) (Simple01 [ -17, -1, 6, -20, -8, -2, 18, -8, -1, -7, 11, 18 ]))))
        ]


simpleEncode02 : Test
simpleEncode02 =
    describe "Simple encode 02"
        [ test "1" (\_ -> equalHack "[]" (Json.Encode.encode 0 (jsonEncSimple02 (Json.Encode.list Json.Encode.int) (Simple02 []))))
        , test "2" (\_ -> equalHack "[-1,0]" (Json.Encode.encode 0 (jsonEncSimple02 (Json.Encode.list Json.Encode.int) (Simple02 [ -1, 0 ]))))
        , test "3" (\_ -> equalHack "[-2,0]" (Json.Encode.encode 0 (jsonEncSimple02 (Json.Encode.list Json.Encode.int) (Simple02 [ -2, 0 ]))))
        , test "4" (\_ -> equalHack "[-3,5,2]" (Json.Encode.encode 0 (jsonEncSimple02 (Json.Encode.list Json.Encode.int) (Simple02 [ -3, 5, 2 ]))))
        , test "5" (\_ -> equalHack "[4,6,7,8,8,-6]" (Json.Encode.encode 0 (jsonEncSimple02 (Json.Encode.list Json.Encode.int) (Simple02 [ 4, 6, 7, 8, 8, -6 ]))))
        , test "6" (\_ -> equalHack "[-6,5,5,-4]" (Json.Encode.encode 0 (jsonEncSimple02 (Json.Encode.list Json.Encode.int) (Simple02 [ -6, 5, 5, -4 ]))))
        , test "7" (\_ -> equalHack "[]" (Json.Encode.encode 0 (jsonEncSimple02 (Json.Encode.list Json.Encode.int) (Simple02 []))))
        , test "8" (\_ -> equalHack "[3,-4,1,7,8,1,8]" (Json.Encode.encode 0 (jsonEncSimple02 (Json.Encode.list Json.Encode.int) (Simple02 [ 3, -4, 1, 7, 8, 1, 8 ]))))
        , test "9" (\_ -> equalHack "[8,5]" (Json.Encode.encode 0 (jsonEncSimple02 (Json.Encode.list Json.Encode.int) (Simple02 [ 8, 5 ]))))
        , test "10" (\_ -> equalHack "[]" (Json.Encode.encode 0 (jsonEncSimple02 (Json.Encode.list Json.Encode.int) (Simple02 []))))
        , test "11" (\_ -> equalHack "[-7,10,12,14,13,-15,-9,17,18,-5,6]" (Json.Encode.encode 0 (jsonEncSimple02 (Json.Encode.list Json.Encode.int) (Simple02 [ -7, 10, 12, 14, 13, -15, -9, 17, 18, -5, 6 ]))))
        ]


simpleEncode03 : Test
simpleEncode03 =
    describe "Simple encode 03"
        ...
        , test "3" (\_ -> equalHack "[2,-4]" (Json.Encode.encode 0 (jsonEncSimple03 (Json.Encode.list Json.Encode.int) (Simple03 [ 2, -4 ]))))
        , test "4" (\_ -> equalHack "[2,2]" (Json.Encode.encode 0 (jsonEncSimple03 (Json.Encode.list Json.Encode.int) (Simple03 [ 2, 2 ]))))
        , test "5" (\_ -> equalHack "[-4]" (Json.Encode.encode 0 (jsonEncSimple03 (Json.Encode.list Json.Encode.int) (Simple03 [ -4 ]))))
        , test "6" (\_ -> equalHack "[9,10]" (Json.Encode.encode 0 (jsonEncSimple03 (Json.Encode.list Json.Encode.int) (Simple03 [ 9, 10 ]))))
        , test "7" (\_ -> equalHack "[-5,-5,6,8,-11,-10,-11]" (Json.Encode.encode 0 (jsonEncSimple03 (Json.Encode.list Json.Encode.int) (Simple03 [ -5, -5, 6, 8, -11, -10, -11 ]))))
        , test "8" (\_ -> equalHack "[-8,-3,-6,-10,-6,11,5,13,2]" (Json.Encode.encode 0 (jsonEncSimple03 (Json.Encode.list Json.Encode.int) (Simple03 [ -8, -3, -6, -10, -6, 11, 5, 13, 2 ]))))
        , test "9" (\_ -> equalHack "[15,14,-12,-14,-13,1,-9,2,4,6,11,14]" (Json.Encode.encode 0 (jsonEncSimple03 (Json.Encode.list Json.Encode.int) (Simple03 [ 15, 14, -12, -14, -13, 1, -9, 2, 4, 6, 11, 14 ]))))
        , test "10" (\_ -> equalHack "[2]" (Json.Encode.encode 0 (jsonEncSimple03 (Json.Encode.list Json.Encode.int) (Simple03 [ 2 ]))))
        , test "11" (\_ -> equalHack "[6]" (Json.Encode.encode 0 (jsonEncSimple03 (Json.Encode.list Json.Encode.int) (Simple03 [ 6 ]))))
        ]


simpleEncode04 : Test
simpleEncode04 =
    describe "Simple encode 04"
        ...
        , test "3" (\_ -> equalHack "[0,-3]" (Json.Encode.encode 0 (jsonEncSimple04 (Json.Encode.list Json.Encode.int) (Simple04 [ 0, -3 ]))))
        , test "4" (\_ -> equalHack "[-5,-1,-2]" (Json.Encode.encode 0 (jsonEncSimple04 (Json.Encode.list Json.Encode.int) (Simple04 [ -5, -1, -2 ]))))
        , test "5" (\_ -> equalHack "[3,-8,1,-8]" (Json.Encode.encode 0 (jsonEncSimple04 (Json.Encode.list Json.Encode.int) (Simple04 [ 3, -8, 1, -8 ]))))
        , test "6" (\_ -> equalHack "[-5,8]" (Json.Encode.encode 0 (jsonEncSimple04 (Json.Encode.list Json.Encode.int) (Simple04 [ -5, 8 ]))))
        , test "7" (\_ -> equalHack "[-10,-4,7,0]" (Json.Encode.encode 0 (jsonEncSimple04 (Json.Encode.list Json.Encode.int) (Simple04 [ -10, -4, 7, 0 ]))))
        , test "8" (\_ -> equalHack "[-4,10,3,3,-10,9,5,-8,-7,-4,-6]" (Json.Encode.encode 0 (jsonEncSimple04 (Json.Encode.list Json.Encode.int) (Simple04 [ -4, 10, 3, 3, -10, 9, 5, -8, -7, -4, -6 ]))))
        , test "9" (\_ -> equalHack "[13,7,-7,-1,-16,-7,7,2,-3,-4,-12]" (Json.Encode.encode 0 (jsonEncSimple04 (Json.Encode.list Json.Encode.int) (Simple04 [ 13, 7, -7, -1, -16, -7, 7, 2, -3, -4, -12 ]))))
        , test "10" (\_ -> equalHack "[-12,13,-18]" (Json.Encode.encode 0 (jsonEncSimple04 (Json.Encode.list Json.Encode.int) (Simple04 [ -12, 13, -18 ]))))
        , test "11" (\_ -> equalHack "[-19,-4]" (Json.Encode.encode 0 (jsonEncSimple04 (Json.Encode.list Json.Encode.int) (Simple04 [ -19, -4 ]))))
        ]


simpleDecode01 : Test
simpleDecode01 =
    describe "Simple decode 01"
...
simplerecordEncode01 =
    describe "SimpleRecord encode 01"
        ...
        , test "3" (\_ -> equalHack "{\"qux\":[0,-4]}" (Json.Encode.encode 0 (jsonEncSimpleRecord01 (Json.Encode.list Json.Encode.int) (SimpleRecord01 { qux = [ 0, -4 ] }))))
        , test "4" (\_ -> equalHack "{\"qux\":[3,1,-2,-6,-3]}" (Json.Encode.encode 0 (jsonEncSimpleRecord01 (Json.Encode.list Json.Encode.int) (SimpleRecord01 { qux = [ 3, 1, -2, -6, -3 ] }))))
        , test "5" (\_ -> equalHack "{\"qux\":[]}" (Json.Encode.encode 0 (jsonEncSimpleRecord01 (Json.Encode.list Json.Encode.int) (SimpleRecord01 { qux = [] }))))
        , test "6" (\_ -> equalHack "{\"qux\":[2,2,3,-10,-4,5,-4,-5,2]}" (Json.Encode.encode 0 (jsonEncSimpleRecord01 (Json.Encode.list Json.Encode.int) (SimpleRecord01 { qux = [ 2, 2, 3, -10, -4, 5, -4, -5, 2 ] }))))
        , test "7" (\_ -> equalHack "{\"qux\":[-5,-6,11,-1,-4,-8,6,9,10]}" (Json.Encode.encode 0 (jsonEncSimpleRecord01 (Json.Encode.list Json.Encode.int) (SimpleRecord01 { qux = [ -5, -6, 11, -1, -4, -8, 6, 9, 10 ] }))))
        , test "8" (\_ -> equalHack "{\"qux\":[1,1,11,5,13,-7,-1,3]}" (Json.Encode.encode 0 (jsonEncSimpleRecord01 (Json.Encode.list Json.Encode.int) (SimpleRecord01 { qux = [ 1, 1, 11, 5, 13, -7, -1, 3 ] }))))
        , test "9" (\_ -> equalHack "{\"qux\":[13,-15,-3,-1,-12,10,-16,4,16,-15,-8,-16,4,-15,16,-9]}" (Json.Encode.encode 0 (jsonEncSimpleRecord01 (Json.Encode.list Json.Encode.int) (SimpleRecord01 { qux = [ 13, -15, -3, -1, -12, 10, -16, 4, 16, -15, -8, -16, 4, -15, 16, -9 ] }))))
        , test "10" (\_ -> equalHack "{\"qux\":[17,11,-11,-3,3,10,-8,17,-13,17,-11,-6,-7,-18,-7,12]}" (Json.Encode.encode 0 (jsonEncSimpleRecord01 (Json.Encode.list Json.Encode.int) (SimpleRecord01 { qux = [ 17, 11, -11, -3, 3, 10, -8, 17, -13, 17, -11, -6, -7, -18, -7, 12 ] }))))
...
simplerecordEncode02 =
    describe "SimpleRecord encode 02"
        ...
        , test "3" (\_ -> equalHack "[-2,4,-4]" (Json.Encode.encode 0 (jsonEncSimpleRecord02 (Json.Encode.list Json.Encode.int) (SimpleRecord02 { qux = [ -2, 4, -4 ] }))))
        , test "4" (\_ -> equalHack "[4,-4,-3,2]" (Json.Encode.encode 0 (jsonEncSimpleRecord02 (Json.Encode.list Json.Encode.int) (SimpleRecord02 { qux = [ 4, -4, -3, 2 ] }))))
        , test "5" (\_ -> equalHack "[-3,0,4]" (Json.Encode.encode 0 (jsonEncSimpleRecord02 (Json.Encode.list Json.Encode.int) (SimpleRecord02 { qux = [ -3, 0, 4 ] }))))
        , test "6" (\_ -> equalHack "[-10]" (Json.Encode.encode 0 (jsonEncSimpleRecord02 (Json.Encode.list Json.Encode.int) (SimpleRecord02 { qux = [ -10 ] }))))
        , test "7" (\_ -> equalHack "[-8,4,1,11,3,-4,-2,-12,-7,-7,5,12]" (Json.Encode.encode 0 (jsonEncSimpleRecord02 (Json.Encode.list Json.Encode.int) (SimpleRecord02 { qux = [ -8, 4, 1, 11, 3, -4, -2, -12, -7, -7, 5, 12 ] }))))
        , test "8" (\_ -> equalHack "[]" (Json.Encode.encode 0 (jsonEncSimpleRecord02 (Json.Encode.list Json.Encode.int) (SimpleRecord02 { qux = [] }))))
        , test "9" (\_ -> equalHack "[16,-12,-8,-15]" (Json.Encode.encode 0 (jsonEncSimpleRecord02 (Json.Encode.list Json.Encode.int) (SimpleRecord02 { qux = [ 16, -12, -8, -15 ] }))))
        , test "10" (\_ -> equalHack "[3,-6]" (Json.Encode.encode 0 (jsonEncSimpleRecord02 (Json.Encode.list Json.Encode.int) (SimpleRecord02 { qux = [ 3, -6 ] }))))
        , test "11" (\_ -> equalHack "[11,0,-16,-13,6]" (Json.Encode.encode 0 (jsonEncSimpleRecord02 (Json.Encode.list Json.Encode.int) (SimpleRecord02 { qux = [ 11, 0, -16, -13, 6 ] }))))
        ]


simplerecordEncode03 : Test
simplerecordEncode03 =
    describe "SimpleRecord encode 03"
        [ test "1" (\_ -> equalHack "{\"qux\":[]}" (Json.Encode.encode 0 (jsonEncSimpleRecord03 (Json.Encode.list Json.Encode.int) (SimpleRecord03 { qux = [] }))))
        , test "2" (\_ -> equalHack "{\"qux\":[0,1]}" (Json.Encode.encode 0 (jsonEncSimpleRecord03 (Json.Encode.list Json.Encode.int) (SimpleRecord03 { qux = [ 0, 1 ] }))))
        , test "3" (\_ -> equalHack "{\"qux\":[4,4]}" (Json.Encode.encode 0 (jsonEncSimpleRecord03 (Json.Encode.list Json.Encode.int) (SimpleRecord03 { qux = [ 4, 4 ] }))))
        , test "4" (\_ -> equalHack "{\"qux\":[2,3,0,1,0]}" (Json.Encode.encode 0 (jsonEncSimpleRecord03 (Json.Encode.list Json.Encode.int) (SimpleRecord03 { qux = [ 2, 3, 0, 1, 0 ] }))))
        , test "5" (\_ -> equalHack "{\"qux\":[4,-6,7,-4,0,-5]}" (Json.Encode.encode 0 (jsonEncSimpleRecord03 (Json.Encode.list Json.Encode.int) (SimpleRecord03 { qux = [ 4, -6, 7, -4, 0, -5 ] }))))
        , test "6" (\_ -> equalHack "{\"qux\":[-2,-7]}" (Json.Encode.encode 0 (jsonEncSimpleRecord03 (Json.Encode.list Json.Encode.int) (SimpleRecord03 { qux = [ -2, -7 ] }))))
        , test "7" (\_ -> equalHack "{\"qux\":[6,-4,4,-5,0]}" (Json.Encode.encode 0 (jsonEncSimpleRecord03 (Json.Encode.list Json.Encode.int) (SimpleRecord03 { qux = [ 6, -4, 4, -5, 0 ] }))))
        , test "8" (\_ -> equalHack "{\"qux\":[14,9,2]}" (Json.Encode.encode 0 (jsonEncSimpleRecord03 (Json.Encode.list Json.Encode.int) (SimpleRecord03 { qux = [ 14, 9, 2 ] }))))
        , test "9" (\_ -> equalHack "{\"qux\":[6,-5,6,-16,-1,16,11,5,-10,14,1,2,-12]}" (Json.Encode.encode 0 (jsonEncSimpleRecord03 (Json.Encode.list Json.Encode.int) (SimpleRecord03 { qux = [ 6, -5, 6, -16, -1, 16, 11, 5, -10, 14, 1, 2, -12 ] }))))
        , test "10" (\_ -> equalHack "{\"qux\":[-5,-10,-9,5]}" (Json.Encode.encode 0 (jsonEncSimpleRecord03 (Json.Encode.list Json.Encode.int) (SimpleRecord03 { qux = [ -5, -10, -9, 5 ] }))))
        , test "11" (\_ -> equalHack "{\"qux\":[12,2,-2,3,-1]}" (Json.Encode.encode 0 (jsonEncSimpleRecord03 (Json.Encode.list Json.Encode.int) (SimpleRecord03 { qux = [ 12, 2, -2, 3, -1 ] }))))
        ]


simplerecordEncode04 : Test
simplerecordEncode04 =
    describe "SimpleRecord encode 04"
        ...
        , test "3" (\_ -> equalHack "[2,-3,-4]" (Json.Encode.encode 0 (jsonEncSimpleRecord04 (Json.Encode.list Json.Encode.int) (SimpleRecord04 { qux = [ 2, -3, -4 ] }))))
        , test "4" (\_ -> equalHack "[3,-4,-3,-2,-4]" (Json.Encode.encode 0 (jsonEncSimpleRecord04 (Json.Encode.list Json.Encode.int) (SimpleRecord04 { qux = [ 3, -4, -3, -2, -4 ] }))))
        , test "5" (\_ -> equalHack "[]" (Json.Encode.encode 0 (jsonEncSimpleRecord04 (Json.Encode.list Json.Encode.int) (SimpleRecord04 { qux = [] }))))
        , test "6" (\_ -> equalHack "[5,10,-4,10,6,0,-4]" (Json.Encode.encode 0 (jsonEncSimpleRecord04 (Json.Encode.list Json.Encode.int) (SimpleRecord04 { qux = [ 5, 10, -4, 10, 6, 0, -4 ] }))))
        , test "7" (\_ -> equalHack "[-6,12,-4,3,-2,-9,0,1,-10]" (Json.Encode.encode 0 (jsonEncSimpleRecord04 (Json.Encode.list Json.Encode.int) (SimpleRecord04 { qux = [ -6, 12, -4, 3, -2, -9, 0, 1, -10 ] }))))
        , test "8" (\_ -> equalHack "[1,5,-10,2,-8,14,-13,7,0,5]" (Json.Encode.encode 0 (jsonEncSimpleRecord04 (Json.Encode.list Json.Encode.int) (SimpleRecord04 { qux = [ 1, 5, -10, 2, -8, 14, -13, 7, 0, 5 ] }))))
        , test "9" (\_ -> equalHack "[-7,-9,-4,8,-3,-12,-10,-12,-14,1,-8]" (Json.Encode.encode 0 (jsonEncSimpleRecord04 (Json.Encode.list Json.Encode.int) (SimpleRecord04 { qux = [ -7, -9, -4, 8, -3, -12, -10, -12, -14, 1, -8 ] }))))
        , test "10" (\_ -> equalHack "[-11,4,4,-4,4,6,7,-12,-1,-17,16,-17,-1,18,-8,-8,6]" (Json.Encode.encode 0 (jsonEncSimpleRecord04 (Json.Encode.list Json.Encode.int) (SimpleRecord04 { qux = [ -11, 4, 4, -4, 4, 6, 7, -12, -1, -17, 16, -17, -1, 18, -8, -8, 6 ] }))))
        , test "11" (\_ -> equalHack "[-8,-4,3,10,13,9,14,9,-19,-20,-13,9,-16,-15,-17,4,-3,-11]" (Json.Encode.encode 0 (jsonEncSimpleRecord04 (Json.Encode.list Json.Encode.int) (SimpleRecord04 { qux = [ -8, -4, 3, 10, 13, 9, 14, 9, -19, -20, -13, 9, -16, -15, -17, 4, -3, -11 ] }))))
        ]


simplerecordDecode01 : Test
simplerecordDecode01 =
    describe "SimpleRecord decode 01"
...
simplerecordDecode02 =
    describe "SimpleRecord decode 02"
...
simplerecordDecode03 =
    describe "SimpleRecord decode 03"
...
simplerecordDecode04 =
    describe "SimpleRecord decode 04"
...
sumEncodeUntagged =
    describe "Sum encode Untagged"
        ...
        , test "3" (\_ -> equalHack "[1,0,-2]" (Json.Encode.encode 0 (jsonEncSumUntagged (Json.Encode.list Json.Encode.int) (SMList [ 1, 0, -2 ]))))
        , test "4" (\_ -> equalHack "[-3]" (Json.Encode.encode 0 (jsonEncSumUntagged (Json.Encode.list Json.Encode.int) (SMList [ -3 ]))))
        , test "5" (\_ -> equalHack "-4" (Json.Encode.encode 0 (jsonEncSumUntagged (Json.Encode.list Json.Encode.int) (SMInt -4))))
        , test "6" (\_ -> equalHack "[-9,1,10,-1,6,0,4,3]" (Json.Encode.encode 0 (jsonEncSumUntagged (Json.Encode.list Json.Encode.int) (SMList [ -9, 1, 10, -1, 6, 0, 4, 3 ]))))
        , test "7" (\_ -> equalHack "[-3,7,5,-11,10,-3,0,-1,9,-2]" (Json.Encode.encode 0 (jsonEncSumUntagged (Json.Encode.list Json.Encode.int) (SMList [ -3, 7, 5, -11, 10, -3, 0, -1, 9, -2 ]))))
        , test "8" (\_ -> equalHack "[12,7]" (Json.Encode.encode 0 (jsonEncSumUntagged (Json.Encode.list Json.Encode.int) (SMList [ 12, 7 ]))))
        , test "9" (\_ -> equalHack "5" (Json.Encode.encode 0 (jsonEncSumUntagged (Json.Encode.list Json.Encode.int) (SMInt 5))))
        , test "10" (\_ -> equalHack "14" (Json.Encode.encode 0 (jsonEncSumUntagged (Json.Encode.list Json.Encode.int) (SMInt 14))))
        , test "11" (\_ -> equalHack "[19]" (Json.Encode.encode 0 (jsonEncSumUntagged (Json.Encode.list Json.Encode.int) (SMList [ 19 ]))))
        ]


sumDecodeUntagged : Test
sumDecodeUntagged =
    describe "Sum decode Untagged"
